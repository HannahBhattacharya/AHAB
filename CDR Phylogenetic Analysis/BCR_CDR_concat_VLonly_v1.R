...
#concatenate all three VL CDRs together into one column
df$CDR.concat <- paste(df$VL.CDR1.sequence,
                       df$VL.CDR2.sequence,
                       df$VL.CDR3.sequence)
...
filename<- paste(dir.out,"VL_CDR123_concat_add_anchor",".fasta",sep="")
